...
const animate = () => {
    ...
    if(stat){
    u.writeT("i love yuuu",0.5*W,0.85*H);
u.writeT("heheheheh",0.5*W,0.9*H);
    u.writeT("maaf yaa udh buang buang waktumu",0.5*W,0.95*H);}
...
const init = () => {
    ...
    turn=0;
    stat=(window.confirm("aku mauu ngomong nihh"));
    ropes=[];
